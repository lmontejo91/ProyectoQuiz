                ...
                <div class="mx-7 p-4 bg-white rounded">
                    ...
                    <form name='formulario_Button' action='./proyectoQuiz_jugar.php' method='POST'>
                        ...
                        <?php foreach ($respuestas as $respuesta):?>
                            <input type='button' class='<?php echo $respuesta['acierto'] ?>' value='<?php echo $respuesta['respuesta'] ?>' onclick='asignarValue()'/>
                        <?php endforeach; ?>

                        <input type='hidden' id='input_hidden' name='preguntaForm_button' value=''/>
